<template>
    <header>
      ...
      <body>
        ...
        <div>
          <label class="title">Enter your questions</label>
          <div class="viewtitle" style="margin: 10px;">
            Enter your questions {{ username }}
        </div>
          
          <label class="questionInput" for="questionInput">Question:</label>
        ...
        <div v-if="questions.length > 0">
          <p class="list">Entered questions:</p>
        ...
        <div>
            <p class="list">Questions submitted: {{ questionCounter }} / {{ NumQuestions }}</p>
        </div>
